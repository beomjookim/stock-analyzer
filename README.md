...
pyarrow 엔진을 활용했고, 과정에서 casting을 없앨 수 있을 줄 알았는데, Spark의 타입과 BigQuery의 타입이 서로 안 맞음.  
그래서 결과적으로 모든 컬럼에 대해 타입 변환을 해줘야했기 때문에 해당 부분에서는 성과 없음.  
